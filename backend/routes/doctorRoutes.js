...
import {
  createDoctor,getAllDoctors,getDoctorById,updateDoctor,deleteDoctor,loginDoctor,logout,sendResetOtp,verifyEmail,resendOtp,isAuthenticated,resetPassword }
...
router.post('/doctor/resend-otp',resendOtp);
